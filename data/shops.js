...
window.LISTINGS = [
  // ---- Newquay ----
  { name: "'The Temple of Fringe' Surf Shop", destination: "England", region: "Cornwall", town: "Newquay",
  ...
  { name: "10 Over Surf Shop", destination: "England", region: "Cornwall", town: "Newquay",
  ...
  { name: "Ann's Cottage", destination: "England", region: "Cornwall", town: "Newquay",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  { name: "Fat Willy's Surf Shack", destination: "England", region: "Cornwall", town: "Newquay",
  ...
  // ---- Bude ----
  { name: "Zuma Jay Surf Shop", destination: "England", region: "Cornwall", town: "Bude",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  // ---- Padstow / St Merryn ----
  { name: "The Pit Surf Shop", destination: "England", region: "Cornwall", town: "St Merryn",
  ...
  // ---- Perranporth ----
  { name: "Bathsheba Surf", destination: "England", region: "Cornwall", town: "Perranporth",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  // ---- St Agnes ----
  { name: "Aggie Surf Shop", destination: "England", region: "Cornwall", town: "St Agnes",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  // ---- Hayle ----
  { name: "Down The Line Surf Co", destination: "England", region: "Cornwall", town: "Hayle",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  // ---- St Ives ----
  { name: "Tiki Surf St Ives", destination: "England", region: "Cornwall", town: "St Ives",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  // ---- Sennen Cove ----
  { name: "Sennen Surf Co", destination: "England", region: "Cornwall", town: "Sennen Cove",
  ...
  { name: "Second Skin", destination: "England", region: "Devon", town: "Braunton",
    ...
    offerings: ["Surfboards", "Wetsuits", "Accessories"] },
  { name: "The Board Barn", destination: "England", region: "Devon", town: "Braunton",
    ...
    offerings: ["Surfboards", "Wetsuits", "Accessories"] },
  // ---- Croyde ----
  { name: "Ralphs Surf Shop", destination: "England", region: "Devon", town: "Croyde",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  // ---- Woolacombe ----
  { name: "The Bay Surf Shop", destination: "England", region: "Devon", town: "Woolacombe",
    ...
    offerings: ["Surfboards", "Wetsuits", "Apparel", "Accessories"] },
  // ---- Westward Ho! ----
  { name: "Ho! Surf", destination: "England", region: "Devon", town: "Westward Ho!",
